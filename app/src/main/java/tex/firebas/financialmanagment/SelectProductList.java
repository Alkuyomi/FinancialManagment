...
public class SelectProductList extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        proList.setOnItemClickListener(new AdapterView.OnItemClickListener() {
            ...
            public void onItemClick(AdapterView<?> adapterView, View view, int i, long l) {
               GLOBAL.SELECTED_PRODUCT_PRICE = prices[i];
               GLOBAL.SELECTED_PRODUCT_TITLE = products[i];
                finish();
            }
        });


        new SelectProductList.DisplayAllProducats().execute();
    }
    ...
    class DisplayAllProducats extends AsyncTask<String,String,String> {
        ...
        protected void onPreExecute() {
            super.onPreExecute();
            progressDialog = new ProgressDialog(SelectProductList.this);
        ...
        protected void onPostExecute(String s) {
            ...
            if(value == 1){
                ...
                ArrayAdapter<String> adapter = new ArrayAdapter<String>(SelectProductList.this , android.R.layout.simple_list_item_1 , android.R.id.text1 , products);
